...
import { MapPin, Monitor, ArrowRight, Building2, Layers } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 mb-16 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          ...
          <Reveal delay={100} className="h-full">
            <div className="h-full bg-zinc-900 border border-zinc-800 p-8 rounded-3xl hover:border-red-900/50 transition-colors group relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="text-[10px] text-zinc-500 bg-black px-2 py-1 rounded border border-zinc-800">#쾌적한환경</span>
                  <span className="text-[10px] text-zinc-500 bg-black px-2 py-1 rounded border border-zinc-800">#대면협업</span>
                  <span className="text-[10px] text-zinc-500 bg-black px-2 py-1 rounded border border-zinc-800">#강남역접근성</span>
                </div>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal delay={200} className="h-full">
            <div className="h-full bg-zinc-900 border border-zinc-800 p-8 rounded-3xl hover:border-blue-900/50 transition-colors group relative overflow-hidden">
              <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-20 transition-opacity">
                 <Layers size={100} />
              </div>
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-2xl font-black text-white">TECH UP 메타버스</h3>
                  <span className="flex items-center gap-1 text-xs font-bold text-blue-500 bg-blue-950/30 px-3 py-1.5 rounded-full border border-blue-900/30">
                    <Monitor size={12} />
                    온라인
                  </span>
                </div>
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="text-[10px] text-zinc-500 bg-black px-2 py-1 rounded border border-zinc-800">#ZEP</span>
                  <span className="text-[10px] text-zinc-500 bg-black px-2 py-1 rounded border border-zinc-800">#시공간초월</span>
                  <span className="text-[10px] text-zinc-500 bg-black px-2 py-1 rounded border border-zinc-800">#몰입형학습</span>
                </div>
              </div>
            </div>
          </Reveal>
